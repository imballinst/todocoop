...
<!-- Show tip regarding room that's not updated for 1 day will be deleted. -->
...
<!-- Show "Add todo" and "Add bulk todo list" buttons. -->
...
<!-- Add admonition suggestion regarding to not store sensitive todos, such as password, emails, etc. -->
...
<!-- Show admonition warning that this will delete entirely the todo without any warning to fasten the deletion process. -->
...
```
Sample input todo 1
Sample input todo 2this will open a modal with the room name and password, which you can use to share them to others.
Sample input todo 3
